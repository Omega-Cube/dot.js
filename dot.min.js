...
c,b){var d,e,f,g,h,i;a*=360;d=Math.floor(a/60)%6;e=a/60-d;a=b*(1-c);f=b*(1-e*c);c=b*(1-(1-e)*c);switch(d){case 0:g=b;h=c;i=a;break;case 1:g=f;h=b;i=a;break;case 2:g=a;h=b;i=c;break;case 3:g=a;h=f;i=b;break;case 4:g=c;h=a;i=b;break;case 5:g=b,h=a,i=f}return"rgb("+Math.round(255*g)+","+Math.round(255*h)+","+Math.round(255*i)+")"},_versionCompare:function(a,c){for(var a=a.split("."),c=c.split("."),b,d;a.length||c.length;){b=a.length?a.shift():0;d=c.length?c.shift():0;if(b<d)return-1;if(b>d)return 1}return 0},
_handleMouseWheel:function(a){if(this._allowMouseScrolling){if(!a)a=window.event;var c=0;a.wheelDelta?(c=a.wheelDelta/120,window.opera&&(c=-c)):a.detail&&(c=-a.detail/3);c&&this.setScale(this.getScale()+c/10);return DotUtils.preventDefault(a)}},_isValidCssSize:function(a){return typeof a==="string"&&this._cssSize.test(a)},_idMatch:'([a-zA-Z\u0080-\uffff_][0-9a-zA-Z\u0080-\uffff_]*|-?(?:\\.\\d+|\\d+(?:\\.\\d*)?)|"(?:\\\\"|[^"])*"|<(?:<[^>]*>|[^<>]+?)+>)'});

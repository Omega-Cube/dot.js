...
DotUtils.argumentNames=function(a){a=a.toString().match(/^[\s\(]*function[^(]*\(([^\)]*)\)/)[1].replace(/\s+/g,"").split(",");return a.length==1&&!a[0]?[]:a};DotUtils.wrap=function(a,b){return function(){return b.apply(this,[DotUtils.bind(this,a)].concat(Array.prototype.slice.call(arguments)))}};DotUtils=function(){};DotUtils.escapeContainer=null;DotUtils.escapeText=null;DotUtils.escapeHtml=function(){DotUtils.escapeContainer=document.createElement("div");DotUtils.escapeText=document.createTextNode("");DotUtils.escapeContainer.appendChild(DotUtils.escapeText);return realEscape=function(a){DotUtils.escapeText.data=a;return DotUtils.escapeContainer.innerHTML}}();DotUtils.setHtml=function(a,b){b=b.replace(/<script[^>]*>([\\S\\s]*?)<\/script>/img,"");a.innerHTML=b};
DotUtils.bind=function(a,b){return function(){return b.apply(a,Array.prototype.slice.call(arguments))}};
DotUtils.ajaxGet=function(a,b,c){var d=null;if(window.XMLHttpRequest)d=new window.XMLHttpRequest;else try{d=new ActiveXObject("MSXML2.XMLHTTP.3.0")}catch(e){d=null}d===null&&alert("Your browser does not support basic AJAX requests");if(typeof b!=="undefined"&&b!==null){var g=false;a.indexOf("?")>-1&&(idFirst=false);for(p in b)g?(a+="?",g=false):a+="&",a+=escape(p)+"="+escape(b[p])}d.open("GET",a,true);d.onreadystatechange=function(){d.readyState==4&&(d.status==200?c(d.responseText):d.status==0&&(alert("It seems you have some cross-domain access issues. Dot.js does not support cross-domain loading (yet ?). I'll still try to load your data but the app might get unstable."),
c(d.responseText)))};d.send()};DotUtils.extend=function(a,b){for(var c in b)a[c]=b[c];return a};DotUtils.addEventHandler=function(a,b,c){a.addEventListener?(b=="mousewheel"&&(b="DOMMouseScroll"),a.addEventListener(b,c,false)):a.attachEvent&&a.attachEvent("on"+b,c)};DotUtils.removeEventHandler=function(a,b,c){a.removeEventHandler?(b=="mousewheel"&&(b="DOMMouseScroll"),a.removeEventHandler(b,c,false)):a.detachEvent&&a.detachEvent("on"+b,c)};
DotUtils.preventDefault=function(a){a.preventDefault&&a.preventDefault();a.stopPropagation&&a.stopPropagation();a.cancelBubble=true;a.cancel=true;a.returnValue=true;return false};
...
draw:function(a,b,c){var d,e,g;if(!c){this.initBB();var h=document.createElement("div");this.dot.elements.appendChild(h)}for(daKey in this.drawAttrs){var f=new DotTokenizer(this.drawAttrs[daKey]);if(d=f.takeChars()){var i="solid";for(a.save();d;){switch(d){case "E":case "e":var l="E"==d,k=f.takeNumber();d=this.dot.height-f.takeNumber();e=f.takeNumber();var o=f.takeNumber(),k=new Ellipse(k,d,e,o);break;case "P":case "p":case "L":var l="P"==d,o="L"!=d,j=f.takeNumber();e=f.takeNumber(2*j);k=new Path;
for(d=2;d<2*j;d+=2)k.addBezier([new Point(e[d-2],this.dot.height-e[d-1]),new Point(e[d],this.dot.height-e[d+1])]);o&&k.addBezier([new Point(e[2*j-2],this.dot.height-e[2*j-1]),new Point(e[0],this.dot.height-e[1])]);break;case "B":case "b":l="b"==d;j=f.takeNumber();e=f.takeNumber(2*j);k=new Path;for(d=2;d<2*j;d+=6)k.addBezier([new Point(e[d-2],this.dot.height-e[d-1]),new Point(e[d],this.dot.height-e[d+1]),new Point(e[d+2],this.dot.height-e[d+3]),new Point(e[d+4],this.dot.height-e[d+5])]);break;case "I":d=
f.takeNumber();e=this.dot.height-f.takeNumber();var o=f.takeNumber(),j=f.takeNumber(),n=f.takeString();this.dot.images[n]||(this.dot.images[n]=new DotImage(this.dot,n));this.dot.images[n].draw(a,d,e-j,o,j);break;case "T":d=Math.round(b*f.takeNumber()+this.dot.padding);e=Math.round(b*this.dot.height+2*this.dot.padding-(b*(f.takeNumber()+this.dot.bbScale*fontSize)+this.dot.padding));o=f.takeNumber();j=Math.round(b*f.takeNumber());n=f.takeString();if(!c&&!/^\s*$/.test(n)){n=DotUtils.escapeHtml(n);do if(matches=
n.match(/ ( +)/)){var q=" ";matches[1].length.times(function(){q+="&nbsp;"});n=n.replace(/  +/,q)}while(matches);var m,r=this.getAttr("URL",true)||this.getAttr("href",true);if(r){var s=this.getAttr("target",true)||"_self",u=this.getAttr("tooltip",true)||this.getAttr("label",true);m=document.createElement("a");m.href=r;m.target=s;m.title=u;var r="onclick,onmousedown,onmouseup,onmouseover,onmousemove,onmouseout".split(","),t;for(t in r)(s=this.getAttr(t,true))&&m.setAttribute(t,s);m.style.textDecoration=
"none"}else m=document.createElement("span");DotUtils.setHtml(m,n);m.style.fontSize=Math.round(fontSize*b*this.dot.bbScale)+"px";m.style.fontFamily=fontFamily;m.style.color=g.textColor;m.style.position="absolute";m.style.textAlign=-1==o?"left":1==o?"right":"center";m.style.left=d-(1+o)*j+"px";m.style.top=e+"px";m.style.width=2*j+"px";if(1!=g.opacity)m.style.opacity=g.opacity;this.dot.elements.appendChild(m)}break;case "C":case "c":d="C"==d;e=this.parseColor(f.takeString());d?a.fillStyle=e.canvasColor:
...
this.width=0;this.bbEnlarge=this.maxHeight=this.maxWidth=false;this.bbScale=1;this.dpi=96;this.bgcolor={opacity:1};this.bgcolor.canvasColor=this.bgcolor.textColor="#ffffff";for(var a=a.split(/\r?\n/),b=0,c,d,e,g,h,f,i,l,k,o,j=[];b<a.length;)if(c=a[b++].replace(/^\s+/,""),""!=c&&"#"!=c.substr(0,1)){for(;b<a.length&&";"!=(d=c.substr(c.length-1,c.length))&&"{"!=d&&"}"!=d;)"\\"==d&&(c=c.substr(0,c.length-1)),c+=a[b++];if(0==j.length){if(e=c.match(this.graphMatchRe))g=new DotGraph(e[3],this),j.unshift(g),
j[0].strict=typeof e[1]!=="undefined",j[0].type="graph"==e[2]?"undirected":"directed",j[0].attrs.xdotversion="1.0",this.graphs.push(j[0])}else if(e=c.match(this.subgraphMatchRe))j.unshift(new DotGraph(e[1],this,g,j[0])),j[1].subgraphs.push(j[0]);if(!e)if("}"==c){if(j.shift(),0==j.length)break}else{if(e=c.match(this.nodeMatchRe))switch(f=e[2],i=e[5],o=j[0].drawAttrs,h=false,f){case "graph":k=j[0].attrs;h=true;break;case "node":k=j[0].nodeAttrs;break;case "edge":k=j[0].edgeAttrs;break;default:c=new DotNode(f,
this,g,j[0]),k=c.attrs,o=c.drawAttrs,j[0].nodes.push(c)}else if(e=c.match(this.edgeMatchRe))f=e[1],i=e[8],c=new DotEdge(f,this,g,j[0],e[2],e[5]),k=c.attrs,o=c.drawAttrs,j[0].edges.push(c);if(e){do{if(0==i.length)break;if(e=i.match(this.attrMatchRe)){if(i=i.substr(e[0].length),c=e[1],l=this.unescape(e[2]),/^_.*draw_$/.test(c)?o[c]=l:k[c]=l,h&&1==j.length)switch(c){case "bb":c=l.split(/,/);this.width=Number(c[2]);this.height=Number(c[3]);break;case "bgcolor":this.bgcolor=g.parseColor(l);break;case "dpi":this.dpi=
...
a=Math.min(a,g.x);b=Math.min(b,g.y);c=Math.max(c,g.x);d=Math.max(d,g.y)}var h=new Rect(a,b,c,d);return(this.getBB=function(){return h})()}},isPointInBB:function(a,b,c){typeof c==="undefined"&&(c=0);var d=this.getBB();0<c&&(d=DotUtils.extend({},d),d.inset(-c,-c));return!(a<d.l||a>d.r||b<d.t||b>d.b)},isPointOnBezier:function(a,b,c){typeof c==="undefined"&&(c=0);if(!this.isPointInBB(a,b,c))return false;for(var d=this.chordPoints(),e=d[0].p,g,h,f,i,l,k,o=1;o<d.length;++o){g=d[o].p;h=e.x;f=e.y;i=g.x;l=
...
this.cy),new Point(this.cx-this.rx,this.cy-this.KAPPA*this.ry),new Point(this.cx-this.KAPPA*this.rx,this.cy-this.ry),new Point(this.cx,this.cy-this.ry)])}});DotTokenizer=DotUtils.createClass({initialize:function(a){this.str=a},takeChars:function(a){a||(a=1);for(var b=[];a--;){var c=this.str.match(/^(\S+)\s*/);c?(this.str=this.str.substr(c[0].length),b.push(c[1])):b.push(false)}return 1==b.length?b[0]:b},takeNumber:function(a){a||(a=1);if(1==a)return Number(this.takeChars());else{for(var b=this.takeChars(a);a--;)b[a]=Number(b[a]);return b}},takeString:function(){var a=Number(this.takeChars()),b=0,c;if("-"!=this.str.charAt(0))return false;for(;0<a;)++b,
c=this.str.charCodeAt(b),128>c?--a:a-=2048>c?2:3;a=this.str.substr(1,b);this.str=this.str.substr(1+b).replace(/^\s+/,"");return a}});DotEntity=DotUtils.createClass({initialize:function(a,b,c,d,e,g){this.defaultAttrHashName=a;this.name=b;this.dot=c;this.rootGraph=d;this.parentGraph=e;this.immediateGraph=g;this.attrs={};this.drawAttrs={}},initBB:function(){var a=this.getAttr("pos").match(/([0-9.]+),([0-9.]+)/),b=Math.round(a[1]),a=Math.round(this.dot.height-a[2]);this.bbRect=new Rect(b,a,b,a)},getAttr:function(a,b){typeof escStrinng==="undefined"&&(b=false);var c=this.attrs[a];if(typeof c==="undefined")for(var d=this.parentGraph;typeof d!==
"undefined";)if(c=d[this.defaultAttrHashName][a],typeof c==="undefined")d=d.parentGraph;else break;c&&b&&(c=c.replace(this.escStringMatchRe,function(a,b){switch(b){case "N":case "E":return this.name;case "T":return this.tailNode;case "H":return this.headNode;case "G":return this.immediateGraph.name;case "L":return this.getAttr("label",true)}return a}.bind(this)));return c},draw:function(a,b,c){var d,e,g;if(!c){this.initBB();var h=document.createElement("div");this.dot.elements.appendChild(h)}for(daKey in this.drawAttrs){var f=
new DotTokenizer(this.drawAttrs[daKey]);if(d=f.takeChars()){var i="solid";for(a.save();d;){switch(d){case "E":case "e":var l="E"==d,k=f.takeNumber();d=this.dot.height-f.takeNumber();e=f.takeNumber();var o=f.takeNumber(),k=new Ellipse(k,d,e,o);break;case "P":case "p":case "L":var l="P"==d,o="L"!=d,j=f.takeNumber();e=f.takeNumber(2*j);k=new Path;for(d=2;d<2*j;d+=2)k.addBezier([new Point(e[d-2],this.dot.height-e[d-1]),new Point(e[d],this.dot.height-e[d+1])]);o&&k.addBezier([new Point(e[2*j-2],this.dot.height-
e[2*j-1]),new Point(e[0],this.dot.height-e[1])]);break;case "B":case "b":l="b"==d;j=f.takeNumber();e=f.takeNumber(2*j);k=new Path;for(d=2;d<2*j;d+=6)k.addBezier([new Point(e[d-2],this.dot.height-e[d-1]),new Point(e[d],this.dot.height-e[d+1]),new Point(e[d+2],this.dot.height-e[d+3]),new Point(e[d+4],this.dot.height-e[d+5])]);break;case "I":d=f.takeNumber();e=this.dot.height-f.takeNumber();var o=f.takeNumber(),j=f.takeNumber(),n=f.takeString();this.dot.images[n]||(this.dot.images[n]=new DotImage(this.dot,
n));this.dot.images[n].draw(a,d,e-j,o,j);break;case "T":d=Math.round(b*f.takeNumber()+this.dot.padding);e=Math.round(b*this.dot.height+2*this.dot.padding-(b*(f.takeNumber()+this.dot.bbScale*fontSize)+this.dot.padding));o=f.takeNumber();j=Math.round(b*f.takeNumber());n=f.takeString();if(!c&&!/^\s*$/.test(n)){n=DotUtils.escapeHtml(n);do if(matches=n.match(/ ( +)/)){var q=" ";matches[1].length.times(function(){q+="&nbsp;"});n=n.replace(/  +/,q)}while(matches);var m,r=this.getAttr("URL",true)||this.getAttr("href",
true);if(r){var s=this.getAttr("target",true)||"_self",u=this.getAttr("tooltip",true)||this.getAttr("label",true);m=document.createElement("a");m.href=r;m.target=s;m.title=u;var r="onclick,onmousedown,onmouseup,onmouseover,onmousemove,onmouseout".split(","),t;for(t in r)(s=this.getAttr(t,true))&&m.setAttribute(t,s);m.style.textDecoration="none"}else m=document.createElement("span");DotUtils.setHtml(m,n);m.style.fontSize=Math.round(fontSize*b*this.dot.bbScale)+"px";m.style.fontFamily=fontFamily;m.style.color=
g.textColor;m.style.position="absolute";m.style.textAlign=-1==o?"left":1==o?"right":"center";m.style.left=d-(1+o)*j+"px";m.style.top=e+"px";m.style.width=2*j+"px";if(1!=g.opacity)m.style.opacity=g.opacity;this.dot.elements.appendChild(m)}break;case "C":case "c":d="C"==d;e=this.parseColor(f.takeString());d?a.fillStyle=e.canvasColor:(g=e,a.strokeStyle=e.canvasColor);break;case "F":fontSize=f.takeNumber();fontFamily=f.takeString();switch(fontFamily){case "Times-Roman":fontFamily="Times New Roman";break;
case "Courier":fontFamily="Courier New";break;case "Helvetica":fontFamily="Arial"}break;case "S":d=f.takeString();switch(d){case "solid":case "filled":break;case "dashed":case "dotted":i=d;break;case "bold":a.lineWidth=2;break;default:(matches=d.match(/^setlinewidth\((.*)\)$/))?a.lineWidth=Number(matches[1]):debug("unknown style "+d)}break;default:debug("unknown token "+d);return}k&&(this.dot.drawPath(a,k,l,i),c||this.bbRect.expandToInclude(k.getBB()),k=void 0);d=f.takeChars()}if(!c)h.style.position=
"absolute",h.style.left=Math.round(b*this.bbRect.l+this.dot.padding)+"px",h.style.top=Math.round(b*this.bbRect.t+this.dot.padding)+"px",h.style.width=Math.round(b*this.bbRect.getWidth())+"px",h.style.height=Math.round(b*this.bbRect.getHeight())+"px";a.restore()}}},parseColor:function(a){var b={opacity:1};if(/^#(?:[0-9a-f]{2}\s*){3,4}$/i.test(a))return this.dot.parseHexColor(a);var c=a.match(/^(\d+(?:\.\d+)?)[\s,]+(\d+(?:\.\d+)?)[\s,]+(\d+(?:\.\d+)?)$/);if(c)return b.canvasColor=b.textColor=this.dot.hsvToRgbColor(c[1],
c[2],c[3]),b;var d=this.getAttr("colorscheme")||"X11",e=a;if(c=a.match(/^\/(.*)\/(.*)$/))c[1]&&(d=c[1]),e=c[2];else if(c=a.match(/^\/(.*)$/))d="X11",e=c[1];e=e.toLowerCase();c=d.toLowerCase();if(c=Dot.prototype.colors[c]){var g=c[e];if(g)return this.dot.parseHexColor("#"+g)}if(g=Dot.prototype.colors.fallback[e])return this.dot.parseHexColor("#"+g);c||debug("unknown color scheme "+d);debug("unknown color "+a+"; color scheme is "+d);b.canvasColor=b.textColor="#000000";return b}});DotNode=DotUtils.createClass(DotEntity,{initialize:function($super,b,c,d,e){$super("nodeAttrs",b,c,d,e,e)}});DotUtils.extend(DotNode.prototype,{escStringMatchRe:/\\([NGL])/g});DotEdge=DotUtils.createClass(DotEntity,{initialize:function($super,b,c,d,e,g,h){$super("edgeAttrs",b,c,d,e,e);this.tailNode=g;this.headNode=h}});DotUtils.extend(DotEdge.prototype,{escStringMatchRe:/\\([EGTHL])/g});DotGraph=DotUtils.createClass(DotEntity,{initialize:function($super,b,c,d,e){$super("attrs",b,c,d,e,this);this.nodeAttrs={};this.edgeAttrs={};this.nodes=[];this.edges=[];this.subgraphs=[]},initBB:function(){var a=this.getAttr("bb").split(",");this.bbRect=new Rect(a[0],this.dot.height-a[1],a[2],this.dot.height-a[3])},draw:function($super,b,c,d){$super(b,c,d);for(var e=[this.subgraphs,this.nodes,this.edges],g=0,h=e.length;g<h;++g)for(var f=e[g],i=0,l=f.length;i<l;++i)f[i].draw(b,c,d)}});
DotUtils.extend(DotGraph.prototype,{escStringMatchRe:/\\([GL])/g});DotImage=DotUtils.createClass({initialize:function(a,b){this.dot=a;++this.dot.numImages;this.finished=this.loaded=false;this.img=new Image;this.img.onload=this.onLoad.bind(this);this.img.onerror=this.onFinish.bind(this);this.img.onabort=this.onFinish.bind(this);this.img.src=this.dot.imagePath+b},onLoad:function(){this.loaded=true;this.onFinish()},onFinish:function(){this.finished=true;++this.dot.numImagesFinished;this.dot.numImages==this.dot.numImagesFinished&&this.dot.draw(true)},draw:function(a,
b,c,d,e){this.finished&&(this.loaded?a.drawImage(this.img,b,c,d,e):(debug("can't load image "+this.img.src),this.drawBrokenImage(a,b,c,d,e)))},drawBrokenImage:function(a,b,c,d,e){a.save();a.beginPath();(new Rect(b,c,b+d,c+d)).draw(a);a.moveTo(b,c);a.lineTo(b+d,c+d);a.moveTo(b+d,c);a.lineTo(b,c+e);a.strokeStyle="#f00";a.lineWidth=1;a.stroke();a.restore()}});Point=DotUtils.createClass({initialize:function(a,b){this.x=a;this.y=b},offset:function(a,b){this.x+=a;this.y+=b},distanceFrom:function(a){var b=this.x-a.x,a=this.y-a.y;return Math.sqrt(b*b+a*a)},makePath:function(a){a.moveTo(this.x,this.y);a.lineTo(this.x+0.001,this.y)}});Bezier=DotUtils.createClass({initialize:function(a){this.points=a;this.order=a.length},pathCommands:[null,function(a,b){this.lineTo(a+0.001,b)},function(a,b){this.lineTo(a,b)},function(a,b,c,d){this.quadraticCurveTo(a,b,c,d)},function(a,b,c,d,e,g){this.bezierCurveTo(a,b,c,d,e,g)}],reset:function(){with(Bezier.prototype)this.controlPolygonLength=controlPolygonLength,this.chordLength=chordLength,this.triangle=triangle,this.chordPoints=chordPoints,this.coefficients=coefficients},offset:function(a,b){for(var c=
0,d=this.points.length;c<d;++c)this.points[c].offset(a,b);this.reset()},getBB:function(){var f;if(this.order){var a,b,c,d;b=this.points[0];a=c=b.x;f=d=b.y,b=f;var e=0;for(a=this.points.length;e<a;++e){var g=this.points[e];a=Math.min(a,g.x);b=Math.min(b,g.y);c=Math.max(c,g.x);d=Math.max(d,g.y)}var h=new Rect(a,b,c,d);return(this.getBB=function(){return h})()}},isPointInBB:function(a,b,c){typeof c==="undefined"&&(c=0);var d=this.getBB();0<c&&(d=DotUtils.extend({},d),d.inset(-c,-c));return!(a<d.l||a>
d.r||b<d.t||b>d.b)},isPointOnBezier:function(a,b,c){typeof c==="undefined"&&(c=0);if(!this.isPointInBB(a,b,c))return false;for(var d=this.chordPoints(),e=d[0].p,g,h,f,i,l,k,o=1;o<d.length;++o){g=d[o].p;h=e.x;f=e.y;i=g.x;l=g.y;k=new Rect(h,f,i,l);if(k.isPointInBB(a,b,c)&&(h=Math.abs(h*l+i*b+a*f-i*f-a*l-h*b),e=e.distanceFrom(g),e=h/e,e<=c))return true;e=g}return false},controlPolygonLength:function(){for(var a=0,b=1;b<this.order;++b)a+=this.points[b-1].distanceFrom(this.points[b]);return(this.controlPolygonLength=
...
c[h],i=c[h+1];g[h]=new Point(f.x*b+i.x*a,f.y*b+i.y*a)}d.push(g);c=g}return d},split:function(a){"undefined"==typeof a&&(a=0.5);for(var a=0.5==a?this.triangle():this.triangleAtT(a),b=Array(this.order),c=Array(this.order),d=0;d<this.order;++d)b[d]=a[d][0],c[d]=a[this.order-1-d][d];return{left:new Bezier(b),right:new Bezier(c)}},mid:function(a,b){return this.split(b).left.split(a/b).right},chordPoints:function(){var a=[{tStart:0,tEnd:0,dt:0,p:this.points[0]}].concat(this._chordPoints(0,1));return(this.chordPoints=
function(){return a})()},_chordPoints:function(a,b){var c=b-a;if(this.controlPolygonLength()<=1.001*this.chordLength())return[{tStart:a,tEnd:b,dt:c,p:this.points[this.order-1]}];else{var c=a+c/2,d=this.split();return d.left._chordPoints(a,c).concat(d.right._chordPoints(c,b))}},markedEvery:function(a,b){for(var c=b||a,d=this.chordPoints(),e=[],g=0,h,f,i=1;i<d.length;++i)if(f=d[i],f.length=f.p.distanceFrom(d[i-1].p),0==f.length)g+=f.dt;else{h=c/f.length*f.dt;for(f.remainingLength=f.length;f.remainingLength>=
c;)f.remainingLength-=c,g+=h,e.push(g),a!=c&&(c=a,h=c/f.length*f.dt);c-=f.remainingLength;g=f.tEnd}return{times:e,nextDistance:c}},coefficients:function(){function a(a){for(;a.length>1;){for(var b=Array(a.length-1),c=0;c<a.length-1;++c){var d=b,e=c,g=a[c],j=a[c+1];g.push(0);var n=Array(g.length);n[0]=g[0];for(var q=0;q<j.length;++q)n[q+1]=g[q+1]+j[q]-g[q];d[e]=n}a=b}return a[0]}for(var b=[],c=[],d=0,e;e=this.points[d++];)b.push([e.x]),c.push([e.y]);var g={xs:a(b),ys:a(c)};return(this.coefficients=
